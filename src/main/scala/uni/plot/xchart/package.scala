package uni.plot.xchart

// The XChart-backed renderer uni.plot used through 0.17.0, kept under this package while
// the SVG renderer in `uni.plot` reaches parity with the Rust port. Same method names and
// parameters; `saveTo` writes PNG here and SVG there. Scheduled for removal.
